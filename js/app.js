  ...
  (() => {
    ...
    const F = {
      loopCreate: function () {
        ...
        for (let e = a.length - 1; e >= 0; e -= 1)
          i.prepend(x(a[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
      },
      loopFix: function () {
        const e = this;
    ...
    function he({ swiper: e, extendParams: t, on: s, emit: n }) {
      ...
      function c() {
        ...
        if ("bullets" === t.type) {
          ...
          i.html(r), (e.pagination.bullets = i.find(ue(t.bulletClass)));
        }
        "fraction" === t.type &&
          ((r = t.renderFraction
    ...
    function fe({ swiper: e, extendParams: t, on: s, emit: n }) {
      let i;
      function r() {
    ...
    function me({ swiper: e, extendParams: t, on: s }) {
      ...
      function r() {
        ...
        const s = t.clickedIndex,
          n = t.clickedSlide;
        if (n && x(n).hasClass(e.params.thumbs.slideThumbActiveClass)) return;
        if (null == s) return;
        let i;
        if (
          ((i = t.params.loop
    ...
    window.addEventListener("load", function (e) {
      !(function () {
        if ((we(), document.querySelector(".thumbs-images"))) {
          const e = new de(".thumbs-images", {
            modules: [pe, he, fe, me],
            observer: !0,
            observeParents: !0,
            slidesPerView: 4,
        ...
        document.querySelector(".bike__slider") &&
          new de(".bike__slider", {
            modules: [pe, he, fe, ve],
            effect: "fade",
            autoplay: { delay: 3e3, disableOnInteraction: !1 },
            ...
            speed: 800,
            loop: !0,
            pagination: { el: ".bike__dotts", clickable: !0 },
          }),
          document.querySelector(".bike-slider__slider") &&
            new de(".bike-slider__slider", {
              modules: [pe, he, fe],
              autoplay: { delay: 3e3, disableOnInteraction: !1 },
              observer: !0,
              observeParents: !0,
              ...
              speed: 800,
              loop: !0,
              pagination: { el: ".bike-slider__dotts", clickable: !0 },
            }),
          ...
          function o(e) {
            ...
            if (s.closest("[data-spoller]")) {
              ...
              r.querySelectorAll("._slide").length ||
                (a && !i.classList.contains("_spoller-active") && l(r),
